/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 390ef9f9ff46da4670038d6a72a055ad)
// Runtime types generated with workerd@1.20260114.0 2025-04-04 
...
/**
 * The **`ServiceWorkerGlobalScope`** interface of the Service Worker API represents the global execution context of a service workers.
...
declare class Event {
    ...
    /**
     * The **`isTrusted`** read-only property of the when the event was generated by the user agent (including via user actions and programmatic methods such as HTMLElement.focus()), and `false` when the event was dispatched via The only exception is the `click` event, which initializes the `isTrusted` property to `false` in user evaluators.
     *
...
/**
 * The **`ExtendableEvent`** interface extends the lifetime of the `install` and `activate` events dispatched on the global scope as part of the service workers lifecycle.
 *
...
interface IncomingRequestCfPropertiesBase extends Record<string, unknown> {
    ...
    /**
     * The number of milliseconds it took for the request to reach your workers.
     *
     * @example 22
     */
    clientTcpRtt?: number;
...
interface IncomingRequestCfPropertiesGeographicInformation {
     ...
     *
     * If your workers is [configured to accept TOR connections](https://support.cloudflare.com/hc/en-us/articles/203306930-Understanding-Cloudflare-Tor-support-and-Onion-Routing), this may also be `"T1"`, indicating a request that originated over TOR.
     *
...
declare namespace TailStream {
    ...
    // This marks the workers handler return information.
    // This is separate from Outcome because the workers invocation can live for a long time after
    ...
    interface SpanContext {
        ...
        // This should be a new traceId for the first workers stage invoked in the eyeball request and then
    ...
    interface TailEvent<Event extends EventType> {
        // invocation id of the currently invoked workers stage.
